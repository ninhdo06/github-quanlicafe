...
class LoginWindow(QtWidgets.QMainWindow):
    def __init__(self, parent_widget): # Thêm parent_widget để điều khiển chuyển trang
        super().__init__()
        self.widget = parent_widget 
        # File .ui nằm ở thư mục view
        uic.loadUi(os.path.join(BASE_DIR, 'view', 'login.ui'), self)
        
        # Kiểm tra xem label_2 có tồn tại không trước khi clear để tránh crash
        if hasattr(self, 'label'): self.label.clear()
        if hasattr(self, 'label_2'): self.label_2.clear()
    ...
    def login(self):
        ...
        # Đường dẫn db phải trỏ vào folder database
        ...
        if result is None:
            ...
            self.widget.setCurrentIndex(2) # Chuyển đến Menu
        else:
